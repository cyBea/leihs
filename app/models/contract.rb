class Contract < ActiveRecord::Base
  ...
  def self.filter(params, user = nil, inventory_pool = nil)
    ...
    # else
      contracts = if user
                    user.contracts #user.contract_lines_bundles
                  elsif inventory_pool
                    inventory_pool.contracts #inventory_pool.contract_lines_bundles
                  else
                    ContractLinesBundle.all
                  end
      klass = ContractLinesBundle
